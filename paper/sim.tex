...
\begin{abstract}
  We introduce an active Multidimensional Scaling (MDS) algorithm
  that, given $n$ objects, learns a similarity matrix over all $n^2$
  pairs by {\em adaptively} sampling crowdsourced responses to
  triplet-based relative similarity queries.  Each query has the form
  ...
  an embedding of the objects into Euclidean space; we refer to this
  as the ``crowd kernel.''
